...
export class FirstMigration1732030027283 implements MigrationInterface {
    name = 'FirstMigration1732030027283'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "rule" ("id" SERIAL NOT NULL, "description" character varying NOT NULL, "houseId" integer, CONSTRAINT "PK_a5577f464213af7ffbe866e3cb5" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "join_request" ("id" SERIAL NOT NULL, "status" integer NOT NULL DEFAULT '0', "houseId" integer, "userId" integer, CONSTRAINT "PK_ea4ce3bfd1dcd38029f3176bb4e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "invitation" ("id" SERIAL NOT NULL, "invitationCode" character varying NOT NULL, "expiresAt" TIMESTAMP NOT NULL, "houseId" integer, CONSTRAINT "PK_beb994737756c0f18a1c1f8669c" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "house_member" ("id" SERIAL NOT NULL, "memberId" integer NOT NULL, "houseId" integer NOT NULL, "status" integer NOT NULL DEFAULT '0', CONSTRAINT "UQ_5ff8051371f4a08f59b4d81bfc9" UNIQUE ("memberId", "houseId"), CONSTRAINT "PK_ace246f2f5e32594b0963364908" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "house" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying NOT NULL, CONSTRAINT "PK_8c9220195fd0a289745855fe908" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "task_assignment" ("id" SERIAL NOT NULL, "userId" integer NOT NULL, "assigneeStatus" integer NOT NULL DEFAULT '0', "taskId" integer, CONSTRAINT "PK_bbd5007caf5731217005cccdc0d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "task" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "description" character varying NOT NULL, "accessLevel" integer NOT NULL DEFAULT '0', "status" integer NOT NULL DEFAULT '0', "dueTime" TIMESTAMP NOT NULL, "ownerId" integer, "houseId" integer, CONSTRAINT "PK_fb213f79ee45060ba925ecd576e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "device_token" ("id" SERIAL NOT NULL, "token" character varying NOT NULL, "device" character varying NOT NULL, "isActive" boolean NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer, CONSTRAINT "PK_592ce89b9ea1a268d6140f60422" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "name" character varying NOT NULL, "nickName" character varying, "avatar" character varying, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
